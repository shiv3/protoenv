...
Some useful protoenv commands are:
   commands    List all available commands of protoenv
   ...
   rehash      Rehash protoenv shims (run this after installing executables)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.protoenv.yaml)")
